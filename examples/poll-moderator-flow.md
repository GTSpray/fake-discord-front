...
<video src="../tests/snapshots/poll-moderator-flow.webm" controls loop autoplay muted playsinline width="720"></video>
...
2. Fill in the form:
   ...
   - **Voters role** *(optional)* — restricts voting to a role
